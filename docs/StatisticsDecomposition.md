...
- [ ] [Индикатор загрузки](https://github.com/SKemenov/iOS-FakeNFT-T5/issues/50) (est: 1 h; fact: x h)
	- [ ] добавить индикатор на главный экран
	- [ ] добавить индикатор на экран пользователя
	- [ ] добавить индикатор на экран коллекции

- [ ] [Рефактор кнопок](https://github.com/SKemenov/iOS-FakeNFT-T5/issues/51) (est: 2 h; fact: x h)
	- [ ] метод кнопки лайка добавляет nft в избранное 
	- [ ] метод кнопки положить в корзину добавляет NFT в корзину


- [ ] [Расширенная логика сортировки](https://github.com/SKemenov/iOS-FakeNFT-T5/issues/52) (est: 1 h; fact: x h)
