...
`Total sprint:` est: 25 h; fact: 24+ h.
...
- [ ] [Рефактор коллекции](https://github.com/SKemenov/iOS-FakeNFT-T5/issues/51) (est: 2 h; fact: x h)
	- [ ] загрузка картинок для NFT
 	- [ ] Хранение NFT 
	- [ ] Хранение данных коллекции

`Total:` est: 5 h; fact: x h.

### Верстка

- [ ] [Рефакторинг верстки](https://github.com/SKemenov/iOS-FakeNFT-T5/issues/49)
	- [ ] Замена вью на кнопку лайка в ячейке коллекции (est: 1 h; fact: x h)
	- [ ] Замена вью на кнопку положить в корзину в ячейке коллекции (est: 1 h; fact: x h)
 	- [ ] Индикатор загрузки коллекции (est: 1 h; fact: x h)
	- [ ] Темная тема (est: 2 h; fact: x h)
	- [ ] Локализация (est: 4 h; fact: x h)

`Total:` est: 9 h; fact: x h.

### Код-ревью

- [ ] [Код-ревью 3 спринта](https://github.com/SKemenov/iOS-FakeNFT-T5/issues/46)
...
`Total sprint:` est: 30 h; fact: x h.


🚀 Челенджи и что можно лучше 
Покрыть UI-тестами экраны, а UNIT-тестами бизнес-логику приложения.
Добавить темную тему (сейчас в темной теме некоторые элементы интерфейса отличаются от макета).
Добавить локализацию на другой язык.
